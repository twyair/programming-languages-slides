...
### Experimenting with Contracts and Modules <!-- 1.2 -->
...
### Experimenting with Nested Contract Boundaries <!-- 1.3 -->
...
## Simple Contracts on Functions <!-- 2 -->
...
### Rolling Your Own Contracts <!-- 2.4 -->
...
### Contracts on Higher-order Functions <!-- 2.5 -->
...
### Dissecting a contract error message <!-- 2.7 -->
...
## Contracts on Functions in General <!-- 3 -->
...
### Optional Keyword Arguments <!-- 3.4 -->
...
### Argument and Result Dependencies <!-- 3.6 -->
...
### Fixed but Statically Unknown Arities <!-- 3.9 -->
...
## Contracts: A Thorough Example <!-- 4 -->
...
### Guarantees for a Specific Value <!-- 5.1 -->
...
### Checking Properties of Data Structures <!-- 5.3 -->
...
## Abstract Contracts using `#:exists` and `#:∃` <!-- 6 -->
...
### A Customer-Manager Component <!-- 7.1 -->
...
### A Parameteric (Simple) Stack <!-- 7.2 -->
...
### Contract Struct Properties <!-- 8.1 -->
...
### With all the Bells and Whistles <!-- 8.2 -->
...
### Contract boundaries and `define/contract` <!-- 9.2 -->
...
### Exists Contracts and Predicates <!-- 9.3 -->
...
### Defining Recursive Contracts <!-- 9.4 -->
...
### Mixing `set!` and `contract-out` <!-- 9.5 -->
